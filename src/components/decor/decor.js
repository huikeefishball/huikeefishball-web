...
export const DecorHeroLeft = () => {
  ...
  return (
    <svg
      className={`${style.root} ${style.left} ${style.hero}`}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 463.4 800"
      width="463.4"
    >
      <foreignObject
        x="112.6"
        y={99.61 + triangle1Offset}
        width="109.96"
        height="96.26"
      >
...
export const DecorHeroRight = () => {
  ...
  useScrollPosition(
    ...
    [circle1Offset, triangle1Offset, triangle2Offset, fish1Offset, fish2Offset]
  )

  return (
    <svg
      className={`${style.root} ${style.right} ${style.hero}`}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 503.65 800"
      width="503.65"
    >
      <foreignObject
        x="286.85"
...
export const DecorAboutLeft = () => {
  ...
  return (
    <svg
      className={`${style.root} ${style.left} no-tablet`}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 350 865"
      width="350"
    >
...
export const DecorAboutRight = () => {
  ...
  return (
    <svg
      className={`${style.root} ${style.right} no-tablet`}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 300 865"
      width="300"
    >
...
export const DecorStyle1Right = () => {
  ...
  useScrollPosition(
    ...
    [triangleOffset, circleOffset, fishOffset]
  )
