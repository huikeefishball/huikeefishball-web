    ...
    <Layout {...restProps}>
        ...
        <div className={style.swiper}>
          ...
          <Swiper {...swiperParams}>
            ...
            {slides.map(({ image: slide }) => (
              <div key={slide} className={`${style.swiperSlide} swiper-slide`}>
                <img
                  src={slide}
      ...
      <section id="about" className={style.about}>
        ...
        <div className="container mx-auto">
          <Quote text={aboutUsQuoteContent} author={aboutUsQuoteAuthor} />
      ...
      <section
        ...
        className={classnames(style.video, {
          [style.videoActive]: isPlayingVideo,
        })}
      ...
      >
        ...
        {!isPlayingVideo && (
          <React.Fragment>
            ...
            />
            <button className={style.playButton} onClick={onPressPlayButton} />
          </React.Fragment>
        )}
        <button className={style.volumeButton} onClick={onPressVolumeButton}>
          <svg
      ...
      <section id="team" className={style.team}>
        ...
        <div className="container mx-auto">
          ...
          <Quote text={teamQuoteContent} author={teamQuoteAuthor} />
        </div>
      </section>
    </Layout>
  )
